...
ATTACK_FILE   = "/home/marine/attack_data/sockshop_m2_raw.json"
TIMELINE_FILE = "/home/marine/attack_data/timeline_sockshop_m2.txt"
VOCAB_FILE    = "/home/marine/vocab.json"
OUTPUT_DIR    = "/home/marine/attack_data/preprocessed_sockshop_m2"
WINDOW_SEC    = 5
...
df[feat_cols].to_csv(f"{OUTPUT_DIR}/features_sockshop_m2.csv", index=False)
df.to_csv(f"{OUTPUT_DIR}/sockshop_m2_features_labeled.csv", index=False)
np.save(f"{OUTPUT_DIR}/features_sockshop_m2.npy", df[feat_cols].values.astype(np.float32))
...
df_raw.to_csv(f"{OUTPUT_DIR}/raw_sockshop_m2.csv", index=False)

print(f"완료!")
print(f"   features_sockshop_m2.csv         — {df[feat_cols].shape}")
print(f"   sockshop_m2_features_labeled.csv — {df.shape}")
print(f"   raw_sockshop_m2.csv              — {df_raw.shape}")
